...
public class FuelPriceClient implements PetrolStationPriceService {
  ...
  @Override
  public Map<Integer, Double> findByLocationAndFuelType(Coordinates coordinates, FuelType fuelType) {
    ...
    var stringHttpResponse = httpClient.exchange(mutableHttpRequest, String.class).firstOrError().blockingGet();
    return PetrolStationsByFuelTypeHtmlParser.parse(stringHttpResponse.body());
  }
}
